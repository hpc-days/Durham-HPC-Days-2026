...
permalink: /programme-days-2026/
classes: [full-programme]
---


{% assign sessions = site.programme-days-2026 | sort: "start_time" %}
                ...
                {% if session_count == 1 %}
                  ...
                  <div class="session-card full-width {{ category_class }}"
                    ...
                    {% if this_session.lead %}
                      <p class="speaker"><strong>Lead:</strong> {{ this_session.lead }}</p>
                    {% endif %}

                    {% if this_session.speaker %}
                      <p class="speaker">
                        <strong>Speaker{% if this_session.speaker contains "," %}s{% endif %}:</strong>
                        {{ this_session.speaker }}
                      </p>
                    {% endif %}
